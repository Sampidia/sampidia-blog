        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
                  ...
                  <Link
                    ...
                    className={`relative px-4 py-2 text-sm font-semibold tracking-wide rounded-lg transition-all duration-200 ${
                      isActive
                        ...
                        : 'text-slate-600 dark:text-slate-300 hover:text-sky-700 dark:hover:text-sky-400 hover:bg-slate-50 dark:hover:bg-slate-900/60'
                    }`}
                  >
                    {link.name}
                    {isActive && (
          ...
          <div className="flex md:hidden items-center gap-3">
            ...
            <button
              ...
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-lg text-slate-600 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-900 focus:outline-none transition-colors"
            ...
            return (
              <Link
                ...
                className={`block px-4 py-3 text-base font-bold rounded-lg transition-colors ${
                  isActive
                    ? 'text-sky-700 dark:text-sky-400 bg-sky-50 dark:bg-sky-950/40'
                    : 'text-slate-600 dark:text-slate-300 hover:text-sky-700 dark:hover:text-sky-400 hover:bg-slate-50 dark:hover:bg-slate-900'
                }`}
              >
                {link.name}
              </Link>
